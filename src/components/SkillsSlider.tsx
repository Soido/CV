...
function SkillSlider() {
  const skillsData: any = [
...

    {
      ...
      name: "JavaScript",
      desc: "Весь функицонал, который просиходит на этой странице написан мной на языке JavaScript и его фреймворков (в том числе этот Слайдер). Конечно в чистом виде я использую его крайне редко. Необходится любая разработка без знаний HTML-разметки, но знания JavaScript без знаний HTML и CSS не существуют.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: <FaReact />,
      name: "React",
      desc: "React — это библиотека JavaScript с открытым кодом для создания внешних пользовательских интерфейсов. Наверное это основной инструмент, который я использую для создания своих проектов. Использование функциональных элементов, так называемых хуков, а также принципов React по использованию вертуального DOM позволяет оптимизировать процессы использования JavaScript, уменьшить объем кода и сделать загрузку веб приложений действительно быстрой.",
    },
    {
      id: 5,
            ...
            {description.map((skill: any, skillIndex: number) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-[4rem] p-[1rem] text-left text-white">
                    {desc}
                  </div>
                </article>
              );
